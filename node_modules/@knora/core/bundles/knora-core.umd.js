(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('json2typescript'), require('rxjs/internal/observable/throwError'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('@knora/core', ['exports', '@angular/common', 'json2typescript', 'rxjs/internal/observable/throwError', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/common/http'], factory) :
    (factory((global.knora = global.knora || {}, global.knora.core = {}),global.ng.common,global.json2typescript,global.rxjs['internal/observable/throwError'],global.rxjs,global.rxjs.operators,global.ng.core,global.ng.common.http));
}(this, (function (exports,common,json2typescript,throwError,rxjs,operators,i0,i1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var OntologyCacheService = /** @class */ (function () {
        ...
        OntologyCacheService.prototype.getEntityDefinitionsForOntologies = function (ontologyIris) {
            ...
            if (ontologyIrisToQuery.length > 0) {
                return this.getAndCacheOntologies(ontologyIrisToQuery).pipe(operators.mergeMap(function () {
        ...
        OntologyCacheService.prototype.getResourceClassDefinitions = function (resourceClassIris) {
            ...
            if (resClassIrisToQueryFor.length > 0) {
                ...
                return this.getAndCacheOntologies(ontologyIris).pipe(operators.mergeMap(function () {
    ...
    var UsersService = /** @class */ (function (_super) {
        ...
        UsersService.prototype.getUsersGroupMemberships = function (userIri) {
            ...
            return this.httpGet(path).pipe(operators.map(function (result) { return result.getBody(GroupsResponse).groups; }), operators.catchError(this.handleJsonError));
        };
        // ------------------------------------------------------------------------
        // POST
        // ------------------------------------------------------------------------
