(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('jdnconvertiblecalendar')) :
    typeof define === 'function' && define.amd ? define('jdnconvertiblecalendardateadapter', ['exports', '@angular/core', '@angular/material', 'jdnconvertiblecalendar'], factory) :
    (factory((global.jdnconvertiblecalendardateadapter = {}),global.ng.core,global.ng.material,global.jdnconvertiblecalendar));
}(this, (function (exports,core,material,jdnconvertiblecalendar) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var JDNConvertibleCalendarDateAdapter = /** @class */ (function (_super) {
         ...
         */
            function (date) {
                ...
                switch (this._activeCalendarFormat) {
                    case 'Gregorian':
                        return new jdnconvertiblecalendar.GregorianCalendarDate(jdnPeriod);
                    case 'Julian':
                        return new jdnconvertiblecalendar.JulianCalendarDate(jdnPeriod);
                }
            };
        /**
         ...
         */
            function (year, month, date, calendar) {
                ...
                /** @type {?} */
                var calDate = new jdnconvertiblecalendar.CalendarDate(year, month + 1, date);
                switch (calendar) {
                    case 'Gregorian':
                        return new jdnconvertiblecalendar.GregorianCalendarDate(new jdnconvertiblecalendar.CalendarPeriod(calDate, calDate));
                    case 'Julian':
                        return new jdnconvertiblecalendar.JulianCalendarDate(new jdnconvertiblecalendar.CalendarPeriod(calDate, calDate));
                }
            };
        /**
         * @param {?} year
         ...
         */
            function () {
                ...
                /** @type {?} */
                var calDate = new jdnconvertiblecalendar.CalendarDate(year, month + 1, day);
                /** @type {?} */
                var dateGregorian = new jdnconvertiblecalendar.GregorianCalendarDate(new jdnconvertiblecalendar.CalendarPeriod(calDate, calDate));
         ...
         */
            function (obj) {
                return (obj instanceof jdnconvertiblecalendar.JDNConvertibleCalendar);
            };
        /**
         * @param {?} date
         * @return {?}
    ...
    var JDNConvertibleCalendarDateAdapterModule = /** @class */ (function () {
        ...
        JDNConvertibleCalendarDateAdapterModule.decorators = [
            { type: core.NgModule, args: [{
                        providers: [
                            { provide: material.DateAdapter, useClass: JDNConvertibleCalendarDateAdapter, deps: [material.MAT_DATE_LOCALE] }
                        ]
                    },] }
        ];
    ...
    exports.JDNConvertibleCalendarDateAdapterModule = JDNConvertibleCalendarDateAdapterModule;
    exports.MatJDNConvertibleCalendarDateAdapterModule = MatJDNConvertibleCalendarDateAdapterModule;
    exports.JDNConvertibleCalendarDateAdapter = JDNConvertibleCalendarDateAdapter;
    exports.ɵa = MAT_JDN_DATE_FORMATS;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=jdnconvertiblecalendardateadapter.umd.js.map